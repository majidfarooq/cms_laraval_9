...
@section('content')
  <div id="@if (isset($page->page_type) && $page->page_type == 'fullpage'){{'fullpage'}}@endif">
    <!-- Page Header-->
    <header class="masthead @if (isset($page->page_type) && $page->page_type == 'fullpage'){{'section'}}@endif" style="background-image: url('{{ isset($page['banner']) ? asset($page['banner']) : '' }}')">
